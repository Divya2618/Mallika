	...
	<div style="margin-left: 0;" class="container">
		<div class="panel panel-default" style="width:1320px;">
			<div class="panel-body">
				...
				<p style="position: relative; float: left; width: 1000px;">Mallika
					...
					hospitality segment, Mallika has rapidly grown in major urban and
				...
				<p style="position: relative; float: left; width: 1000px;">Explore
					a new city in India with Mallika Hotels, where you can experience a
